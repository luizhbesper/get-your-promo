...
//TODO: Implement a function to save the new receiver
  ...
  return (
    <form className="flex items-center gap" onSubmit={handleSubmit(onSubmit)}>
      <input
      ...
      <div className="flex items-center">
        ...
        <div className="flex items-center gap-x-2 w-16">
          <DownloadSimple className="text-zinc-300" size={18} weight="bold" />
          <p className="text-zinc-300 font-semibold">{promo.downloads}</p>
        </div>
